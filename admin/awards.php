...
<head>
    ...
    <title>Manage Awards - Ratu Lawyer</title>
...
<body>
    ...
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="award_form.php" class="btn btn-primary">Add New Award</a>
        </div>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            <a href="award_form.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
                            <a href="awards.php?delete=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger"
