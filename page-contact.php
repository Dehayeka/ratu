...
<body class="">
  ...
  <div id="smooth-wrapper">
    <div id="smooth-content">
      ...
      <section class="contact-section bg-no-repeat bg-cover pdt-110 pdb-110" data-background="images/bg/home1-bg1.png"
        data-overlay-dakr="9">
        <div class="container">
                ...
                <div class="col-lg-6 col-xl-4">
                  <div class="contact_info_02 d-flex mrb-30">
                    ...
                    <div class="contact-details mrl-30">
                      <h5 class="icon-box-title mrb-10">Indonesian Address</h5>
                      <p class="mrb-0">Gg. II No.43-44, Cilinaya, Kec. Cakranegara, Kota Mataram, Nusa Tenggara Bar.
                        83232</p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6 col-xl-4">
                  <div class="contact_info_02 d-flex mrb-30">
                    ...
                    <div class="contact-details mrl-30">
                      ...
                      <p class="mrb-0">ratu@gmail.com</p>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6 col-xl-4">
                  <div class="contact_info_02 d-flex mrb-30">
                    ...
                    <div class="contact-details mrl-30">
                      ...
                      <p class="mrb-0">+62 819-1590-4275</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-8">
                      <div class="form-group">
                        <button type="submit" name="submit" class="cs-btn-one btn-circle mrb-lg-60" value="Send">Submit
                          Now</button>
                      </div>
                    </div>
                  </div>
        ...
        <div class="mapouter fixed-height">
          <div class="gmap_canvas">
            <iframe id="gmap_canvas"
              src="https://maps.google.com/maps?q=Gg.%20II%20No.43-44,%20Cilinaya,%20Kec.%20Cakranegara,%20Kota%20Mataram,%20Nusa%20Tenggara%20Bar.%2083232&t=&z=13&ie=UTF8&iwloc=&output=embed"></iframe>
