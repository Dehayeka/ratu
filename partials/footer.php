<footer class="footer bg-cover bg-black pos-rel" data-background="images/bg/footer-blur-bg2.png">
                ...
                <div class="col-xl-12">
                    <div class="pdt-30 pdb-30 footer-border-top-bottom">
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 text-center text-md-end"><span>Info@gmail.com</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row pdt-30 pdb-30 footer-copyright-area">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="text-center">
                        <span>Copyright by <strong>
                                <?php echo htmlspecialchars(isset($profile) ? $profile['name'] : 'Ratu Lawyer'); ?>
                            </strong> © 2025. All rights reserved </span>
                    </div>
                </div>
                <div class="col"></div>
            </div>
    ...
    <img class="h1_footer_oval_shape" src="images/footer/oval.png" alt="" />
</footer>
