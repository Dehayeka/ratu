<!DOCTYPE html>
<html lang="en">
 <?php $title='Services Style 03 - Personal Portfolio Resume PHP Template'?>
  ...
  <body class="">
    ...
    <div id="smooth-wrapper">
      <div id="smooth-content">
            ...
            <div class="row">
              <div class="col-xl-12">
                <div class="breadcrumb-area">
                  <h2 class="page-title">Services Style 03</h2>
                  <ul class="breadcrumbs-link">
                    <li><a href="index.php">Home</a></li>
                    <li class="active">Services Style 03</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <section class="pdt-120 award_section">
